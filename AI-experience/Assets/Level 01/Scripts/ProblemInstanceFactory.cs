...
public class ProblemInstanceFactory {
	...
	public ProblemInstance GetDemoProblemInstance() {
		...
		string[] enigm_texts = new string[]{
			"Bernard a 4 ans et sa soeur a la moitié de son âge.\nQuelle âge a la soeur de Bertrand si Bertrand a 40 ans ?", 
			...
			"Sur le chemin pour aller au supermarché, vous comptez 20 maisons sur votre droite et au retour, vous en dénombrez 20 sur votre gauche." };
